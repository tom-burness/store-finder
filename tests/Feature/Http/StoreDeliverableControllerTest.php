...
class StoreDeliverableControllerTest extends TestCase
{
    use RefreshDatabase;

    public function test_index_returns_unauthorized()
    {
        $response = $this->json('GET', '/api/stores/deliverable', [
            'postcode' => 'SE9 9AF'
        ]);
    ...
    public function test_index_returns_store_with_correct_distance_and_order()
    {
        ...
        $response = $this->json('GET', '/api/stores/deliverable?postcode=SE9 9AF');
